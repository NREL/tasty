...
def test_is_valid(get_g36_data, get_g36_shapes, shape_name, target_node):
    # -- Setup
...
@pytest.mark.parametrize('shape_name, target_node, remove_markers', [
    ...
    [PH_SHAPES['ZoneAirTemperatureOverrideCommandShape'], SAMPLE['VAV-01-ZoneAirTemperatureOverrideCommand'], ['zone']],
...
def test_is_invalid(get_g36_data, get_g36_shapes, shape_name, target_node, remove_markers):
    # -- Setup
    data_graph = get_g36_data
    shapes_graph = get_g36_shapes
    ont_graph = tg.load_ontology('Haystack', '3.9.9')

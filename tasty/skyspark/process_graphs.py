...
class SkysparkGraphProcessor:
    ...
    def determine_missing_points(self, results_graph, severity_level="violation"):
        """
        Given a results_graph generated by pySHACL's validate method, this method returns a dict containing a list of required points
        that were not validated (i.e. are missing) from the equipment, and a list of optional points that were not validated.

        :param results_graph: the rdf results graph returned by pySHACL's validate method
        :return: a dict containing two lists - 'required' is a list of the missing required points, 'optional' is a list of missing
        optional points.
        :rtype: a dict with the structure { 'required': [...], 'optional': [...] }
        """
        missing_required_points = []
        missing_optional_points = []
        ...
        missing_point_dict = {
            ...
            'optional': missing_optional_points
        }

        return missing_point_dict
